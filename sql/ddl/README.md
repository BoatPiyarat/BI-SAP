...
| 037_fix_expected_invoice_no_null_unsafe.sql | **Live source definition of `sp_refresh_expected_state`; current source not yet deployed.** Includes the NULL-safe fix plus RULE-01/02/08 period handling and RULE-09 OLD_YEAR_NO_TOUCH rescue. Commit `b881fa3` adds fail-closed exact-one-active-period and non-future-start guards pending Class A review/deploy approval |
