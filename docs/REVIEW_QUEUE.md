...
Class: A
Artifact: commit `8b1f2bb`; `docs/design/POST_IMPORT_AUTOMATION_DEPLOYMENT.md`.
...
Evidence: `git diff --check` passed. Review IAM separation, no default service account, resource
