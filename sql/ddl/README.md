...
| 085_v3_onetime_create_shadow.sql | **Source only / Class A.** Scenario 1 ordinary RCB/ONETIME CREATE: conserved READY/hold routing and exact 56-column shadow; CreditShell held separately; no GCS write |
